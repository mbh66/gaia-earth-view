...
- Use GitHub's [private vulnerability reporting](https://github.com/bioconomy-earth/gaia-earth-view/security/advisories/new) (Security tab → "Report a vulnerability"), or
